...
public:
    ...
    friend int operator<<(BSTStringStack& bst, const std::pair<int, std::string>& p);

    friend int operator>>(BSTStringStack& bst, std::pair<int, std::string>& p);

    BSTStringStack& operator=(const BSTStringStack& other);
};